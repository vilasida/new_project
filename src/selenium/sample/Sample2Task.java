...
//         get first text of class "test" (should be "Test Text 1")
        //driver.findElement(By.className("test")).getAttribute()
...
//         get text of class "test"
        ...
        for (WebElement myElements : allElements) {
            System.out.println(driver.findElements(By.className("test")).get(2).getText());
//         get third text of class "test" (should be "Test Text 4")
            //System.out.println(driver.findElement(By.className("test")).get());
            //System.out.println(driver.findElement(By.classAll("randomButton2")).getAttribute("id"));
        }
